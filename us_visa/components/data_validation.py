...
logging = get_logger("data_Validation.py")
...
class DataValidation:
    ...
    def detect_dataset_drift(self, reference_df: DataFrame, current_df: DataFrame, ) -> bool:
        ...
        """
        try:
           # Create report with new Evidently API
            ...
            # Convert to JSON
            json_report = drift_report.as_dict()
            ...
            logging.info(f"{n_drifted}/{n_features} features drifted.")
